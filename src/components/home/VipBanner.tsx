...
export default function VipBanner() {
    return (
        <div className="w-full mx-auto mt-2 md:mt-0 mb-6 md:mb-0 px-4 md:px-0">
            {/* 🚀 변경된 부분: transform-gpu isolate 클래스와 WebkitMaskImage 인라인 스타일 추가! 
                 이제 모바일/사파리 환경에서도 모서리 영상이 삐져나오며 깜빡거리지 않습니다. */}
            <div
                className="relative w-full h-[90px] sm:h-[180px] md:h-[120px] rounded-[10px] md:rounded-[20px] overflow-hidden shadow-md md:shadow-2xl flex flex-row items-center justify-between px-4 sm:px-6 md:px-12 py-3.5 md:py-0 group text-left bg-black transform-gpu isolate"
